...
import { parseCipl } from '../cipl/parse-omron'
...
describe('G78495IQ — merges two cable lines, keeps the motor separate', () => {
...
describe('K78027EC — CEVA, groups across different part numbers', () => {
