/**
 * Parser for the Omron combined Commercial Invoice & Packing List layout.
 *
...
export function parseCiplPages(fileName: string, pages: TextPage[]): ParsedCipl {
  ...
  // K78027EC prints 6 of its 8 order numbers there. The line items are authoritative.
...
function parsePackingBlock(
  ...
  // entirely and prints only the section totals (K78464FJ). With one line in the section
