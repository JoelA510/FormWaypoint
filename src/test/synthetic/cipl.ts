/**
 * Builds CIPL PDFs that reproduce the Omron layouts without reproducing a customer's data.
 *
...
function drawHeaderPage(doc: PDFDocument, spec: SyntheticCipl, set: string, kind: string, font: PDFFont) {
  ...
  let y = 757
  text(page, 'Omron Robotics and Safety Technologies, Inc.', 308, y, font)
